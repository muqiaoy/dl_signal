...
np.save('/projects/rsalakhugroup/complex/music_train_x_%d_toy.npy' % (k), Xtrain_aggregated)
np.save('/projects/rsalakhugroup/complex/music_train_y_%d_toy.npy' % (k), Ytrain_aggregated)
...
np.save('/projects/rsalakhugroup/complex/music_test_x_%d_toy.npy' % (k_test), Xtest_aggregated)
np.save('/projects/rsalakhugroup/complex/music_test_y_%d_toy.npy' % (k_test), Ytest_aggregated)
