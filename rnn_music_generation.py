...
from utils import SignalDataset_music_raw
...
start = time.time()
# load data
training_set = SignalDataset_music_raw(path, time_step=total_time_step, train=True)
train_loader = torch.utils.data.DataLoader(training_set, **params_dataloader)

test_set = SignalDataset_music_raw(path, time_step=total_time_step, train=False)
